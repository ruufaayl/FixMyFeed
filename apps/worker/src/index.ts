 ...
 * @fixmyfeed/worker
 *
 * Durable worker process: imports, synchronization, diagnostics, repair execution, exports, notifications, sitemap generation.
 *
 ...
 */
export const workspaceName = "@fixmyfeed/worker" as const;
