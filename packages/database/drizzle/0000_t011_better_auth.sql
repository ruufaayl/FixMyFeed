...
CREATE INDEX "authentication_verifications_identifier_idx" ON "authentication_verifications" USING btree ("identifier");--> statement-breakpoint
CREATE INDEX "authentication_verifications_expires_at_idx" ON "authentication_verifications" USING btree ("expires_at");--> statement-breakpoint
CREATE UNIQUE INDEX "sessions_token_unique" ON "sessions" USING btree ("token");--> statement-breakpoint
CREATE INDEX "sessions_user_id_idx" ON "sessions" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "sessions_expires_at_idx" ON "sessions" USING btree ("expires_at");--> statement-breakpoint
CREATE UNIQUE INDEX "user_identities_provider_account_unique" ON "user_identities" USING btree ("provider_id","account_id");--> statement-breakpoint
