---
document_id: FD-92C5DAEB
title: "T071 — Implement streaming CSV TSV XML and JSON parsers"
...
# T071 — Implement streaming CSV TSV XML and JSON parsers

## Purpose

Authorizes one bounded implementation change for Implement streaming CSV TSV XML and JSON parsers.

## Scope

This document is the implementation authority for T071 — Implement streaming CSV TSV XML and JSON parsers. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of T071 — Implement streaming CSV TSV XML and JSON parsers.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Implement exactly the behavior required for Implement streaming CSV TSV XML and JSON parsers.
...
Files and packages directly required for `Implement streaming CSV TSV XML and JSON parsers` plus traceability, tests, and generated contracts. Shared-package changes must be minimal, backwards-compatible, and documented.
