---
document_id: FD-E461699E
title: "T045 — Implement Shopify privacy and uninstall callbacks"
...
# T045 — Implement Shopify privacy and uninstall callbacks

## Purpose

Authorizes one bounded implementation change for Implement Shopify privacy and uninstall callbacks.

## Scope

This document is the implementation authority for T045 — Implement Shopify privacy and uninstall callbacks. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.

## Dependencies

- `/AGENTS.md`
- `/IMPLEMENTATION_BASELINE.md`
- `/implementation/epics/E04-shopify-source-connector.md`
...
- A conforming implementation of T045 — Implement Shopify privacy and uninstall callbacks.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Implement exactly the behavior required for Implement Shopify privacy and uninstall callbacks.
...
Files and packages directly required for `Implement Shopify privacy and uninstall callbacks` plus traceability, tests, and generated contracts. Shared-package changes must be minimal, backwards-compatible, and documented.
