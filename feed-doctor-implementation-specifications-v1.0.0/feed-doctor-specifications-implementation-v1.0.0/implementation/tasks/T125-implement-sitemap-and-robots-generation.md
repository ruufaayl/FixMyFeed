---
document_id: FD-4F7FA4E1
title: "T125 — Implement sitemap and robots generation"
...
# T125 — Implement sitemap and robots generation

## Purpose

Authorizes one bounded implementation change for Implement sitemap and robots generation.

## Scope

This document is the implementation authority for T125 — Implement sitemap and robots generation. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of T125 — Implement sitemap and robots generation.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Implement exactly the behavior required for Implement sitemap and robots generation.
...
Files and packages directly required for `Implement sitemap and robots generation` plus traceability, tests, and generated contracts. Shared-package changes must be minimal, backwards-compatible, and documented.
