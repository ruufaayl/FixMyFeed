---
document_id: FD-ABB39E9C
title: "T122 — Implement SSRF hardened public URL tools"
...
# T122 — Implement SSRF hardened public URL tools

## Purpose

Authorizes one bounded implementation change for Implement SSRF hardened public URL tools.

## Scope

This document is the implementation authority for T122 — Implement SSRF hardened public URL tools. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of T122 — Implement SSRF hardened public URL tools.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Implement exactly the behavior required for Implement SSRF hardened public URL tools.
...
Files and packages directly required for `Implement SSRF hardened public URL tools` plus traceability, tests, and generated contracts. Shared-package changes must be minimal, backwards-compatible, and documented.
