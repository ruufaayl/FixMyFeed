---
document_id: FD-11968C34
title: "T072 — Implement schema mapping and import preview"
...
# T072 — Implement schema mapping and import preview

## Purpose

Authorizes one bounded implementation change for Implement schema mapping and import preview.

## Scope

This document is the implementation authority for T072 — Implement schema mapping and import preview. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of T072 — Implement schema mapping and import preview.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Implement exactly the behavior required for Implement schema mapping and import preview.
...
Files and packages directly required for `Implement schema mapping and import preview` plus traceability, tests, and generated contracts. Shared-package changes must be minimal, backwards-compatible, and documented.
