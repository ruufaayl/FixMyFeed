---
document_id: FD-F465FDA1
title: "E04 — Shopify Source Connector"
...
# E04 — Shopify Source Connector

## Purpose

Defines the delivery boundary, dependencies, outcomes, and acceptance gates for the Shopify Source Connector epic.

## Scope

This document is the implementation authority for E04 — Shopify Source Connector. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of E04 — Shopify Source Connector.
