...
Defines the production implementation, governance, failure behavior, and verification requirements for backup and restore.
...
- The implementation MUST provide the complete backup and restore capability according to the reference architecture.
