---
document_id: FD-EBD00860
title: "Money Currency And Decimal Standard"
...
# Money Currency And Decimal Standard

## Purpose

Defines the production implementation, governance, failure behavior, and verification requirements for money currency and decimal standard.

## Scope

This document is the implementation authority for Money Currency And Decimal Standard. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Money Currency And Decimal Standard.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete money currency and decimal standard capability according to the reference architecture.
