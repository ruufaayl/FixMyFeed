---
document_id: FD-14954B97
title: "ADR-032: Encrypted Connector Credentials"
...
# ADR-032: Encrypted Connector Credentials

## Purpose

Records the binding architecture decision: Use application-level authenticated encryption for provider credentials.

## Scope

This document is the implementation authority for ADR-032: Encrypted Connector Credentials. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-032: Encrypted Connector Credentials.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use application-level authenticated encryption for provider credentials.
