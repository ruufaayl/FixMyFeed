---
document_id: FD-71769396
title: "ADR-014: Transactional Outbox"
...
Records the binding architecture decision: Use a transactional outbox for domain event emission.

## Scope

This document is the implementation authority for ADR-014: Transactional Outbox. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-014: Transactional Outbox.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use a transactional outbox for domain event emission.
