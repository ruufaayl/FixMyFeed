---
document_id: FD-B12B8EC8
title: "ADR-047: Four-Eyes High-Risk Approval"
...
# ADR-047: Four-Eyes High-Risk Approval

## Purpose

Records the binding architecture decision: Support separation of proposer and approver for high-risk bulk repairs.

## Scope

This document is the implementation authority for ADR-047: Four-Eyes High-Risk Approval. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-047: Four-Eyes High-Risk Approval.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Support separation of proposer and approver for high-risk bulk repairs.
