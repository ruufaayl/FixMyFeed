---
document_id: FD-97F95E1E
title: "ADR-043: Audit Log Separation"
...
# ADR-043: Audit Log Separation

## Purpose

Records the binding architecture decision: Keep immutable audit records separate from operational logs and analytics.

## Scope

This document is the implementation authority for ADR-043: Audit Log Separation. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-043: Audit Log Separation.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Keep immutable audit records separate from operational logs and analytics.
