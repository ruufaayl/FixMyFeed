---
document_id: FD-69EFE229
title: "ADR-012: UUIDv7 Identifiers"
...
Records the binding architecture decision: Use UUIDv7-compatible opaque identifiers generated application-side.

## Scope

This document is the implementation authority for ADR-012: UUIDv7 Identifiers. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-012: UUIDv7 Identifiers.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use UUIDv7-compatible opaque identifiers generated application-side.
