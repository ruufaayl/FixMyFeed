---
document_id: FD-903EA384
title: "ADR-028: Indexability State Machine"
...
# ADR-028: Indexability State Machine

## Purpose

Records the binding architecture decision: Make search indexability an explicit reviewed content state.

## Scope

This document is the implementation authority for ADR-028: Indexability State Machine. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-028: Indexability State Machine.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Make search indexability an explicit reviewed content state.
