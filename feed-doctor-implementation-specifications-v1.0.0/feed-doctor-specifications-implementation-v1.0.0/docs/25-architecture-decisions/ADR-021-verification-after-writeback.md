---
document_id: FD-010018C1
title: "ADR-021: Verification After Writeback"
...
# ADR-021: Verification After Writeback

## Purpose

Records the binding architecture decision: Verify every external repair through a fresh read and validator rerun.

## Scope

This document is the implementation authority for ADR-021: Verification After Writeback. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-021: Verification After Writeback.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Verify every external repair through a fresh read and validator rerun.
