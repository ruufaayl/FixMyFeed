---
document_id: FD-2F967CC3
title: "ADR-018: Immutable Snapshots"
...
# ADR-018: Immutable Snapshots

## Purpose

Records the binding architecture decision: Store source and feed snapshots immutably and derive current normalized state.

## Scope

This document is the implementation authority for ADR-018: Immutable Snapshots. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-018: Immutable Snapshots.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Store source and feed snapshots immutably and derive current normalized state.
