---
document_id: FD-63D2EEAB
title: "ADR-036: Shopify GraphQL Only"
...
# ADR-036: Shopify GraphQL Only

## Purpose

Records the binding architecture decision: Use Shopify GraphQL Admin API with bulk operations and verified webhooks.

## Scope

This document is the implementation authority for ADR-036: Shopify GraphQL Only. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-036: Shopify GraphQL Only.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use Shopify GraphQL Admin API with bulk operations and verified webhooks.
