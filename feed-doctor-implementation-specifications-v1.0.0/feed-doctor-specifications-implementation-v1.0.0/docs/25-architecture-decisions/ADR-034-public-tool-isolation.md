---
document_id: FD-C551483B
title: "ADR-034: Public Tool Isolation"
...
# ADR-034: Public Tool Isolation

## Purpose

Records the binding architecture decision: Run public diagnostic tools through isolated, quota-limited, SSRF-hardened execution.

## Scope

This document is the implementation authority for ADR-034: Public Tool Isolation. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-034: Public Tool Isolation.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Run public diagnostic tools through isolated, quota-limited, SSRF-hardened execution.
