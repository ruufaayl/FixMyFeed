---
document_id: FD-787E2A35
title: "ADR-003: Node.js 24 LTS"
...
# ADR-003: Node.js 24 LTS

## Purpose

Records the binding architecture decision: Use Node.js 24 LTS as the supported server runtime.

## Scope

This document is the implementation authority for ADR-003: Node.js 24 LTS. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-003: Node.js 24 LTS.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use Node.js 24 LTS as the supported server runtime.
