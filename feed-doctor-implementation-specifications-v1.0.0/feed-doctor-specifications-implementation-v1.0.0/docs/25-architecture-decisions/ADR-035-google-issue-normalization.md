---
document_id: FD-421D1BDE
title: "ADR-035: Google Issue Normalization"
...
# ADR-035: Google Issue Normalization

## Purpose

Records the binding architecture decision: Map changing Google issue codes into stable internal issue definitions and aliases.

## Scope

This document is the implementation authority for ADR-035: Google Issue Normalization. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-035: Google Issue Normalization.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Map changing Google issue codes into stable internal issue definitions and aliases.
