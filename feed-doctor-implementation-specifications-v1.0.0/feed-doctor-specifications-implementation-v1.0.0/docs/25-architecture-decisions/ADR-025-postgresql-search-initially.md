---
document_id: FD-B39E1F27
title: "ADR-025: PostgreSQL Search Initially"
...
# ADR-025: PostgreSQL Search Initially

## Purpose

Records the binding architecture decision: Use PostgreSQL full-text search until measured scale justifies a dedicated service.

## Scope

This document is the implementation authority for ADR-025: PostgreSQL Search Initially. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-025: PostgreSQL Search Initially.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use PostgreSQL full-text search until measured scale justifies a dedicated service.
