---
document_id: FD-5E18040B
title: "ADR-024: First-Party Analytics"
...
# ADR-024: First-Party Analytics

## Purpose

Records the binding architecture decision: Use consent-aware first-party analytics stored initially in PostgreSQL.

## Scope

This document is the implementation authority for ADR-024: First-Party Analytics. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-024: First-Party Analytics.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use consent-aware first-party analytics stored initially in PostgreSQL.
