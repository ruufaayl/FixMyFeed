---
document_id: FD-66AEB553
title: "ADR-049: OpenTelemetry Compatibility"
...
# ADR-049: OpenTelemetry Compatibility

## Purpose

Records the binding architecture decision: Instrument using OpenTelemetry-compatible concepts without requiring paid telemetry.

## Scope

This document is the implementation authority for ADR-049: OpenTelemetry Compatibility. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-049: OpenTelemetry Compatibility.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Instrument using OpenTelemetry-compatible concepts without requiring paid telemetry.
