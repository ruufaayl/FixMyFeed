---
document_id: FD-06C92C5A
title: "ADR-023: No Automatic Paid Overage"
...
# ADR-023: No Automatic Paid Overage

## Purpose

Records the binding architecture decision: Fail closed at cost and quota ceilings; never purchase automatic overage.

## Scope

This document is the implementation authority for ADR-023: No Automatic Paid Overage. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-023: No Automatic Paid Overage.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Fail closed at cost and quota ceilings; never purchase automatic overage.
