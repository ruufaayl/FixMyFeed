---
document_id: FD-36B84976
title: "ADR-044: Private Tool Results"
...
# ADR-044: Private Tool Results

## Purpose

Records the binding architecture decision: Keep user-specific public-tool results private and noindex.

## Scope

This document is the implementation authority for ADR-044: Private Tool Results. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-044: Private Tool Results.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Keep user-specific public-tool results private and noindex.
