---
document_id: FD-8488AF5B
title: "ADR-002: Next.js 16 App Router"
...
Records the binding architecture decision: Use Next.js 16 App Router for public and authenticated web surfaces while keeping domain logic framework-neutral.

## Scope

This document is the implementation authority for ADR-002: Next.js 16 App Router. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-002: Next.js 16 App Router.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use Next.js 16 App Router for public and authenticated web surfaces while keeping domain logic framework-neutral.
