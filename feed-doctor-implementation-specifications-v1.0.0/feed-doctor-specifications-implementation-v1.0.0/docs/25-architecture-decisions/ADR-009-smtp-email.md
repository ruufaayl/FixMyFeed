---
document_id: FD-ABB27EC8
title: "ADR-009: SMTP Email"
...
Records the binding architecture decision: Use standard SMTP as the mandatory email abstraction; vendor APIs are optional adapters.

## Scope

This document is the implementation authority for ADR-009: SMTP Email. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-009: SMTP Email.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use standard SMTP as the mandatory email abstraction; vendor APIs are optional adapters.
