---
document_id: FD-F6284491
title: "ADR-004: PostgreSQL 17+"
...
# ADR-004: PostgreSQL 17+

## Purpose

Records the binding architecture decision: Use PostgreSQL 17 or newer supported major as the transactional source of truth.

## Scope

This document is the implementation authority for ADR-004: PostgreSQL 17+. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-004: PostgreSQL 17+.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use PostgreSQL 17 or newer supported major as the transactional source of truth.
