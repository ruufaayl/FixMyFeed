---
document_id: FD-10332794
title: "ADR-011: Connector Boundary"
...
# ADR-011: Connector Boundary

## Purpose

Records the binding architecture decision: Isolate every external platform behind a normalized versioned connector contract.

## Scope

This document is the implementation authority for ADR-011: Connector Boundary. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-011: Connector Boundary.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Isolate every external platform behind a normalized versioned connector contract.
