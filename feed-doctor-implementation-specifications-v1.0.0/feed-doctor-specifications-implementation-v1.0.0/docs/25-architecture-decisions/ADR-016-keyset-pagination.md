---
document_id: FD-13770581
title: "ADR-016: Keyset Pagination"
...
# ADR-016: Keyset Pagination

## Purpose

Records the binding architecture decision: Use keyset pagination for unbounded collections.

## Scope

This document is the implementation authority for ADR-016: Keyset Pagination. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-016: Keyset Pagination.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use keyset pagination for unbounded collections.
