---
document_id: FD-28BBB228
title: "ADR-017: Optimistic Concurrency"
...
# ADR-017: Optimistic Concurrency

## Purpose

Records the binding architecture decision: Use resource versions and conditional updates for mutable domain records.

## Scope

This document is the implementation authority for ADR-017: Optimistic Concurrency. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-017: Optimistic Concurrency.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use resource versions and conditional updates for mutable domain records.
