---
document_id: FD-C43F47CE
title: "ADR-037: WooCommerce Reconciliation"
...
# ADR-037: WooCommerce Reconciliation

## Purpose

Records the binding architecture decision: Treat WooCommerce webhooks as acceleration and periodic reconciliation as authority.

## Scope

This document is the implementation authority for ADR-037: WooCommerce Reconciliation. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-037: WooCommerce Reconciliation.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Treat WooCommerce webhooks as acceleration and periodic reconciliation as authority.
