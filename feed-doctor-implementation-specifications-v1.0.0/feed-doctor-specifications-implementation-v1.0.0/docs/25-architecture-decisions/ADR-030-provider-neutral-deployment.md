---
document_id: FD-A3A3003D
title: "ADR-030: Provider-Neutral Deployment"
...
# ADR-030: Provider-Neutral Deployment

## Purpose

Records the binding architecture decision: Maintain Docker portability even when using Vercel for web delivery.

## Scope

This document is the implementation authority for ADR-030: Provider-Neutral Deployment. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-030: Provider-Neutral Deployment.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Maintain Docker portability even when using Vercel for web delivery.
