---
document_id: FD-9467F277
title: "ADR-045: Hard Retention Limits"
...
# ADR-045: Hard Retention Limits

## Purpose

Records the binding architecture decision: Apply lifecycle deletion to temporary uploads, exports, and raw snapshots.

## Scope

This document is the implementation authority for ADR-045: Hard Retention Limits. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-045: Hard Retention Limits.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Apply lifecycle deletion to temporary uploads, exports, and raw snapshots.
