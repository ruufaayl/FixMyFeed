---
document_id: FD-F6128315
title: "ADR-022: Feature-Flagged Billing"
...
# ADR-022: Feature-Flagged Billing

## Purpose

Records the binding architecture decision: Keep billing disabled until owner-supplied provider credentials and approval.

## Scope

This document is the implementation authority for ADR-022: Feature-Flagged Billing. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-022: Feature-Flagged Billing.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Keep billing disabled until owner-supplied provider credentials and approval.
