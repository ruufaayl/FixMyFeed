---
document_id: FD-20D2A53F
title: "ADR-015: At-Least-Once Events"
...
# ADR-015: At-Least-Once Events

## Purpose

Records the binding architecture decision: Use at-least-once event delivery with idempotent consumers.

## Scope

This document is the implementation authority for ADR-015: At-Least-Once Events. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-015: At-Least-Once Events.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use at-least-once event delivery with idempotent consumers.
