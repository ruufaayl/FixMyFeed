---
document_id: FD-85D73E11
title: "ADR-020: Preview Before Writeback"
...
# ADR-020: Preview Before Writeback

## Purpose

Records the binding architecture decision: Require deterministic previews and source-version capture before external mutation.

## Scope

This document is the implementation authority for ADR-020: Preview Before Writeback. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-020: Preview Before Writeback.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Require deterministic previews and source-version capture before external mutation.
