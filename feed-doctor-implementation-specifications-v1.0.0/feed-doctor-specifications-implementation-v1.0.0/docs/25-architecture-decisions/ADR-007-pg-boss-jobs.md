---
document_id: FD-A6E906CC
title: "ADR-007: pg-boss Jobs"
...
# ADR-007: pg-boss Jobs

## Purpose

Records the binding architecture decision: Use PostgreSQL-backed pg-boss for jobs, scheduling, retries, and dead letters in bootstrap.

## Scope

This document is the implementation authority for ADR-007: pg-boss Jobs. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-007: pg-boss Jobs.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use PostgreSQL-backed pg-boss for jobs, scheduling, retries, and dead letters in bootstrap.
