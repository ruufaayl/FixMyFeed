---
document_id: FD-6F5A265F
title: "ADR-039: No Hardcoded Free Tiers"
...
# ADR-039: No Hardcoded Free Tiers

## Purpose

Records the binding architecture decision: Represent provider quotas as configuration, not business logic.

## Scope

This document is the implementation authority for ADR-039: No Hardcoded Free Tiers. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-039: No Hardcoded Free Tiers.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Represent provider quotas as configuration, not business logic.
