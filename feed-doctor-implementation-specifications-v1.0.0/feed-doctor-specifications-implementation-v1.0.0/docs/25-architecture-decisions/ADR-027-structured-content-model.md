---
document_id: FD-9FB3D410
title: "ADR-027: Structured Content Model"
...
# ADR-027: Structured Content Model

## Purpose

Records the binding architecture decision: Store public content as structured reviewed records, not unrestricted raw HTML.

## Scope

This document is the implementation authority for ADR-027: Structured Content Model. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-027: Structured Content Model.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Store public content as structured reviewed records, not unrestricted raw HTML.
