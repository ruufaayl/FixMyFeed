---
document_id: FD-D269E1BE
title: "ADR-038: Merchant API Version Adapter"
...
# ADR-038: Merchant API Version Adapter

## Purpose

Records the binding architecture decision: Pin Google Merchant API behind an adapter and migration certification suite.

## Scope

This document is the implementation authority for ADR-038: Merchant API Version Adapter. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-038: Merchant API Version Adapter.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Pin Google Merchant API behind an adapter and migration certification suite.
