---
document_id: FD-5398B624
title: "ADR-041: No External AI Requirement"
...
# ADR-041: No External AI Requirement

## Purpose

Records the binding architecture decision: Core functionality remains complete with all external model providers disabled.

## Scope

This document is the implementation authority for ADR-041: No External AI Requirement. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-041: No External AI Requirement.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Core functionality remains complete with all external model providers disabled.
