---
document_id: FD-1759265F
title: "ADR-031: Expand-Migrate-Contract"
...
# ADR-031: Expand-Migrate-Contract

## Purpose

Records the binding architecture decision: Use expand/migrate/contract database changes for zero-downtime compatibility.

## Scope

This document is the implementation authority for ADR-031: Expand-Migrate-Contract. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-031: Expand-Migrate-Contract.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use expand/migrate/contract database changes for zero-downtime compatibility.
