---
document_id: FD-8473DAE4
title: "ADR-040: No Secrets in Jobs"
...
# ADR-040: No Secrets in Jobs

## Purpose

Records the binding architecture decision: Jobs contain credential references, never plaintext credentials.

## Scope

This document is the implementation authority for ADR-040: No Secrets in Jobs. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-040: No Secrets in Jobs.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Jobs contain credential references, never plaintext credentials.
