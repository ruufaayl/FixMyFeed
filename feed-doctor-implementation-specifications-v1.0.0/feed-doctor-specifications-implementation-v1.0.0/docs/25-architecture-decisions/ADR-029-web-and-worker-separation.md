---
document_id: FD-504D3A15
title: "ADR-029: Web and Worker Separation"
...
# ADR-029: Web and Worker Separation

## Purpose

Records the binding architecture decision: Deploy request-serving web and durable workers as separate process types.

## Scope

This document is the implementation authority for ADR-029: Web and Worker Separation. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-029: Web and Worker Separation.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Deploy request-serving web and durable workers as separate process types.
