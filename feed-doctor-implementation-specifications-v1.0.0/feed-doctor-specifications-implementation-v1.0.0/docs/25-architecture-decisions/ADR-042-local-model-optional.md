---
document_id: FD-00C39D0E
title: "ADR-042: Local Model Optional"
...
# ADR-042: Local Model Optional

## Purpose

Records the binding architecture decision: Allow an optional private local-model adapter for suggestions only.

## Scope

This document is the implementation authority for ADR-042: Local Model Optional. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-042: Local Model Optional.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Allow an optional private local-model adapter for suggestions only.
