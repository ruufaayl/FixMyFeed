---
document_id: FD-554C356A
title: "ADR-005: Drizzle ORM"
...
Records the binding architecture decision: Use Drizzle for typed schema and migrations, with reviewed SQL for advanced constraints and indexes.

## Scope

This document is the implementation authority for ADR-005: Drizzle ORM. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-005: Drizzle ORM.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use Drizzle for typed schema and migrations, with reviewed SQL for advanced constraints and indexes.
