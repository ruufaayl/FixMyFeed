---
document_id: FD-BB39B9E6
title: "ADR-046: Canonical API Envelope"
...
# ADR-046: Canonical API Envelope

## Purpose

Records the binding architecture decision: Use one versioned success, collection, operation, and error envelope.

## Scope

This document is the implementation authority for ADR-046: Canonical API Envelope. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-046: Canonical API Envelope.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use one versioned success, collection, operation, and error envelope.
