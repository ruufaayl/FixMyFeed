---
document_id: FD-BA379A16
title: "ADR-006: Better Auth"
...
Records the binding architecture decision: Use self-hosted Better Auth to avoid mandatory identity-provider fees and preserve portability.

## Scope

This document is the implementation authority for ADR-006: Better Auth. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-006: Better Auth.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Use self-hosted Better Auth to avoid mandatory identity-provider fees and preserve portability.
