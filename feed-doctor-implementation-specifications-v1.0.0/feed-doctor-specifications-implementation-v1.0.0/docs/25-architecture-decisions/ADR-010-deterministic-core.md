---
document_id: FD-EBB844EC
title: "ADR-010: Deterministic Core"
...
# ADR-010: Deterministic Core

## Purpose

Records the binding architecture decision: Make deterministic validators and repair rules authoritative; AI remains optional and non-authoritative.

## Scope

This document is the implementation authority for ADR-010: Deterministic Core. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-010: Deterministic Core.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Make deterministic validators and repair rules authoritative; AI remains optional and non-authoritative.
