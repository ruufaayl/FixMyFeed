---
document_id: FD-28D98A38
title: "ADR-033: Support Access Grants"
...
# ADR-033: Support Access Grants

## Purpose

Records the binding architecture decision: Require time-limited customer-approved support access.

## Scope

This document is the implementation authority for ADR-033: Support Access Grants. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of ADR-033: Support Access Grants.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Require time-limited customer-approved support access.
