---
document_id: FD-810E4CCF
title: "F115 — Human Review Of Ai Output"
...
# F115 — Human Review Of Ai Output

## Purpose

Defines the end-to-end production requirements for the human review of ai output feature.

## Scope

This document is the implementation authority for F115 — Human Review Of Ai Output. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of F115 — Human Review Of Ai Output.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The feature MUST implement the complete `human review of ai output` workflow using versioned domain and API contracts.
...
- `human_review_of_ai_output_viewed` when the workflow becomes usable.
- `human_review_of_ai_output_started` after validated user intent.
- `human_review_of_ai_output_completed` only after durable success.
- `human_review_of_ai_output_failed` with canonical error category and retryability.
- `human_review_of_ai_output_cancelled` or `abandoned` when distinguishable.
