---
document_id: FD-5F08C331
title: "F047 — Four Eyes Approval"
...
# F047 — Four Eyes Approval

## Purpose

Defines the end-to-end production requirements for the four eyes approval feature.

## Scope

This document is the implementation authority for F047 — Four Eyes Approval. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of F047 — Four Eyes Approval.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The feature MUST implement the complete `four eyes approval` workflow using versioned domain and API contracts.
...
- `four_eyes_approval_viewed` when the workflow becomes usable.
- `four_eyes_approval_started` after validated user intent.
- `four_eyes_approval_completed` only after durable success.
- `four_eyes_approval_failed` with canonical error category and retryability.
- `four_eyes_approval_cancelled` or `abandoned` when distinguishable.
