---
document_id: FD-E8228E1E
title: "F012 — Shopify Installation"
...
# F012 — Shopify Installation

## Purpose

Defines the end-to-end production requirements for the shopify installation feature.

## Scope

This document is the implementation authority for F012 — Shopify Installation. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of F012 — Shopify Installation.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The feature MUST implement the complete `shopify installation` workflow using versioned domain and API contracts.
...
- `shopify_installation_viewed` when the workflow becomes usable.
- `shopify_installation_started` after validated user intent.
- `shopify_installation_completed` only after durable success.
- `shopify_installation_failed` with canonical error category and retryability.
- `shopify_installation_cancelled` or `abandoned` when distinguishable.
