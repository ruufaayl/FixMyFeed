---
document_id: FD-05E5E5AA
title: "F094 — Public Gtin Validator"
...
# F094 — Public Gtin Validator

## Purpose

Defines the end-to-end production requirements for the public gtin validator feature.

## Scope

This document is the implementation authority for F094 — Public Gtin Validator. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of F094 — Public Gtin Validator.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The feature MUST implement the complete `public gtin validator` workflow using versioned domain and API contracts.
...
- `public_gtin_validator_viewed` when the workflow becomes usable.
- `public_gtin_validator_started` after validated user intent.
- `public_gtin_validator_completed` only after durable success.
- `public_gtin_validator_failed` with canonical error category and retryability.
- `public_gtin_validator_cancelled` or `abandoned` when distinguishable.
