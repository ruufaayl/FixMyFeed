---
document_id: FD-1ED4F49B
title: "F037 — Issue Prioritization"
...
# F037 — Issue Prioritization

## Purpose

Defines the end-to-end production requirements for the issue prioritization feature.

## Scope

This document is the implementation authority for F037 — Issue Prioritization. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of F037 — Issue Prioritization.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The feature MUST implement the complete `issue prioritization` workflow using versioned domain and API contracts.
...
- `issue_prioritization_viewed` when the workflow becomes usable.
- `issue_prioritization_started` after validated user intent.
- `issue_prioritization_completed` only after durable success.
- `issue_prioritization_failed` with canonical error category and retryability.
- `issue_prioritization_cancelled` or `abandoned` when distinguishable.
