---
document_id: FD-92E46974
title: "F035 — Issue Explanation"
...
# F035 — Issue Explanation

## Purpose

Defines the end-to-end production requirements for the issue explanation feature.

## Scope

This document is the implementation authority for F035 — Issue Explanation. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of F035 — Issue Explanation.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The feature MUST implement the complete `issue explanation` workflow using versioned domain and API contracts.
...
- `issue_explanation_viewed` when the workflow becomes usable.
- `issue_explanation_started` after validated user intent.
- `issue_explanation_completed` only after durable success.
- `issue_explanation_failed` with canonical error category and retryability.
- `issue_explanation_cancelled` or `abandoned` when distinguishable.
