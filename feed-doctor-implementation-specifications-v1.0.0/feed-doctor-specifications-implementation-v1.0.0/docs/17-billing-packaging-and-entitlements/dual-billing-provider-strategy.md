---
document_id: FD-A0920D80
title: "Dual Billing Provider Strategy"
...
# Dual Billing Provider Strategy

## Purpose

Defines the production implementation, governance, failure behavior, and verification requirements for dual billing provider strategy.

## Scope

This document is the implementation authority for Dual Billing Provider Strategy. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Dual Billing Provider Strategy.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete dual billing provider strategy capability according to the reference architecture.
