---
document_id: FD-3F01EB44
title: "Downgrade Workflow"
...
Defines the production implementation, governance, failure behavior, and verification requirements for downgrade workflow.

## Scope

This document is the implementation authority for Downgrade Workflow. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Downgrade Workflow.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete downgrade workflow capability according to the reference architecture.
