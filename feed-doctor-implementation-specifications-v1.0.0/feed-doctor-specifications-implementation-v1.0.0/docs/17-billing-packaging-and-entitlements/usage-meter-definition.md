---
document_id: FD-8497F424
title: "Usage Meter Definition"
...
Defines the production implementation, governance, failure behavior, and verification requirements for usage meter definition.

## Scope

This document is the implementation authority for Usage Meter Definition. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Usage Meter Definition.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete usage meter definition capability according to the reference architecture.
