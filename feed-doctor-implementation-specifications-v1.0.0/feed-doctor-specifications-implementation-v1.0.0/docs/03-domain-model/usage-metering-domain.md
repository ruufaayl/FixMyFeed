---
document_id: FD-AC154AA8
title: "Usage Metering Domain"
...
# Usage Metering Domain

## Purpose

Defines the domain model for Usage records immutable measured units and aggregates them under versioned meter definitions.

## Scope

This document is the implementation authority for Usage Metering Domain. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Usage Metering Domain.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Usage records immutable measured units and aggregates them under versioned meter definitions.
...
The owning aggregate for `usage-metering-domain` is modified through one application service and tenant-aware repository. Related records outside the aggregate are referenced by ID or coordinated asynchronously.
