---
document_id: FD-D81BE4CF
title: "Platform Account Domain"
...
Defines the domain model for Platform accounts represent authenticated external resources and relationships, independent of stores.

## Scope

This document is the implementation authority for Platform Account Domain. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Platform Account Domain.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Platform accounts represent authenticated external resources and relationships, independent of stores.
...
The owning aggregate for `platform-account-domain` is modified through one application service and tenant-aware repository. Related records outside the aggregate are referenced by ID or coordinated asynchronously.
