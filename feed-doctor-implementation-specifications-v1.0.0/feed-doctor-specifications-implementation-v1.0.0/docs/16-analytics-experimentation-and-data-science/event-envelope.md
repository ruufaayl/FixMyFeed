...
Defines the production implementation, governance, failure behavior, and verification requirements for event envelope.
...
- The implementation MUST provide the complete event envelope capability according to the reference architecture.
