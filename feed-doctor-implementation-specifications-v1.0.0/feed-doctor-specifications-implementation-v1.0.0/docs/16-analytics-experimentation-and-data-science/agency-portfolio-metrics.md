---
document_id: FD-C340BC3C
title: "Agency Portfolio Metrics"
...
# Agency Portfolio Metrics

## Purpose

Defines the production implementation, governance, failure behavior, and verification requirements for agency portfolio metrics.

## Scope

This document is the implementation authority for Agency Portfolio Metrics. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Agency Portfolio Metrics.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete agency portfolio metrics capability according to the reference architecture.
