---
document_id: FD-26BF66BE
title: "Merchant Health Score"
...
Defines the production implementation, governance, failure behavior, and verification requirements for merchant health score.

## Scope

This document is the implementation authority for Merchant Health Score. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Merchant Health Score.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete merchant health score capability according to the reference architecture.
