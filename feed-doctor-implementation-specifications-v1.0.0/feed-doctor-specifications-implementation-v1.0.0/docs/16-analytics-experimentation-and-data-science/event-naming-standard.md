---
document_id: FD-BC73F882
title: "Event Naming Standard"
...
Defines the production implementation, governance, failure behavior, and verification requirements for event naming standard.

## Scope

This document is the implementation authority for Event Naming Standard. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Event Naming Standard.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete event naming standard capability according to the reference architecture.
