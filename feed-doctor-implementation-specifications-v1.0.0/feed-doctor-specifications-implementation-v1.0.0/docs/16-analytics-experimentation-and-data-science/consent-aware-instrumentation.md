---
document_id: FD-54100858
title: "Consent Aware Instrumentation"
...
Defines the production implementation, governance, failure behavior, and verification requirements for consent aware instrumentation.

## Scope

This document is the implementation authority for Consent Aware Instrumentation. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Consent Aware Instrumentation.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete consent aware instrumentation capability according to the reference architecture.
