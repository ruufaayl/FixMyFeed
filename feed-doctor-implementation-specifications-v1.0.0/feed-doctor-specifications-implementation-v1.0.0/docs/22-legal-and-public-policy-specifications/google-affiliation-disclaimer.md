---
document_id: FD-393F8A1F
title: "Google Affiliation Disclaimer"
...
# Google Affiliation Disclaimer

## Purpose

Defines product and engineering requirements for States that Feed Doctor is independent and does not guarantee Google approval or affiliation.

## Scope

This document is the implementation authority for Google Affiliation Disclaimer. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Google Affiliation Disclaimer.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- States that Feed Doctor is independent and does not guarantee Google approval or affiliation.
