---
document_id: FD-97F31210
title: "Shopify Affiliation Disclaimer"
...
# Shopify Affiliation Disclaimer

## Purpose

Defines product and engineering requirements for States marketplace relationship accurately and avoids implying endorsement.

## Scope

This document is the implementation authority for Shopify Affiliation Disclaimer. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Shopify Affiliation Disclaimer.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- States marketplace relationship accurately and avoids implying endorsement.
