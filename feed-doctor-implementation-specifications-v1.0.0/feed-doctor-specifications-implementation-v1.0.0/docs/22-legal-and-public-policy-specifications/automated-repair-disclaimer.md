---
document_id: FD-0624FFAE
title: "Automated Repair Disclaimer"
...
# Automated Repair Disclaimer

## Purpose

Defines product and engineering requirements for Explains preview, authorization, external processing, reversibility limits, verification, and merchant responsibility.

## Scope

This document is the implementation authority for Automated Repair Disclaimer. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Automated Repair Disclaimer.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Explains preview, authorization, external processing, reversibility limits, verification, and merchant responsibility.
