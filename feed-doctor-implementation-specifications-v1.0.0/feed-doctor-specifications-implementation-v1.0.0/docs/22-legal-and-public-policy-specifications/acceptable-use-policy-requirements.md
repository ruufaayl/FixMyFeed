---
document_id: FD-883B4B58
title: "Acceptable Use Policy Requirements"
...
Defines product and engineering requirements for Prohibits unlawful catalogs, credential abuse, scraping abuse, malware, denial of service, policy evasion, and misuse of repair automation.

## Scope

This document is the implementation authority for Acceptable Use Policy Requirements. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Acceptable Use Policy Requirements.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- Prohibits unlawful catalogs, credential abuse, scraping abuse, malware, denial of service, policy evasion, and misuse of repair automation.
