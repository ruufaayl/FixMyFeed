---
document_id: FD-00EA9821
title: "Issue Resolved Webhook"
...
# Issue Resolved Webhook

## Purpose

Defines the outbound webhook contract for the issue resolved event.

## Scope

This document is the implementation authority for Issue Resolved Webhook. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Issue Resolved Webhook.
