---
document_id: FD-051F674F
title: "Repair Failed Webhook"
...
# Repair Failed Webhook

## Purpose

Defines the outbound webhook contract for the repair failed event.

## Scope

This document is the implementation authority for Repair Failed Webhook. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Repair Failed Webhook.
