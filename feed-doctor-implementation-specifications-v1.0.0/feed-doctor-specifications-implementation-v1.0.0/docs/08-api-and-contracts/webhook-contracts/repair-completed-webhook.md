---
document_id: FD-276D713E
title: "Repair Completed Webhook"
...
# Repair Completed Webhook

## Purpose

Defines the outbound webhook contract for the repair completed event.

## Scope

This document is the implementation authority for Repair Completed Webhook. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Repair Completed Webhook.
