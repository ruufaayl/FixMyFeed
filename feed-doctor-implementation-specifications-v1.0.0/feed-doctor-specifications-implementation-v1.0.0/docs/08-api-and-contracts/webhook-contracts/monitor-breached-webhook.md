---
document_id: FD-4216EC44
title: "Monitor Breached Webhook"
...
# Monitor Breached Webhook

## Purpose

Defines the outbound webhook contract for the monitor breached event.

## Scope

This document is the implementation authority for Monitor Breached Webhook. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Monitor Breached Webhook.
