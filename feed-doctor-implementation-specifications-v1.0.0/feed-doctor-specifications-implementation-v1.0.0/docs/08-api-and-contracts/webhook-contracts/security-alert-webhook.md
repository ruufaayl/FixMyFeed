---
document_id: FD-7EA51600
title: "Security Alert Webhook"
...
Defines the outbound webhook contract for the security alert event.

## Scope

This document is the implementation authority for Security Alert Webhook. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Security Alert Webhook.
