---
document_id: FD-66F6F1A3
title: "Approval Required Webhook"
...
# Approval Required Webhook

## Purpose

Defines the outbound webhook contract for the approval required event.

## Scope

This document is the implementation authority for Approval Required Webhook. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Approval Required Webhook.
