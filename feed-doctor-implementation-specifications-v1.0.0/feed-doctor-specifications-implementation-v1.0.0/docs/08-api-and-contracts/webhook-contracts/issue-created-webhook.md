---
document_id: FD-6039784C
title: "Issue Created Webhook"
...
Defines the outbound webhook contract for the issue created event.

## Scope

This document is the implementation authority for Issue Created Webhook. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Issue Created Webhook.
