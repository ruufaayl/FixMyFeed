---
document_id: FD-C88DACBD
title: "Persona — Feed Specialist"
...
# Persona — Feed Specialist

## Purpose

Defines the goals, permissions, risks, information needs, and success criteria for this persona. Understands product data deeply; needs granular evidence, rules, bulk operations, and auditability.

## Scope

This document is the implementation authority for Persona — Feed Specialist. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Feed Specialist.
...
Understands product data deeply; needs granular evidence, rules, bulk operations, and auditability.
