---
document_id: FD-232D5DB9
title: "User Journey — First Connection"
...
Defines the end-to-end actors, prerequisites, steps, system states, handoffs, failures, and completion evidence for first connection.

## Scope

This document is the implementation authority for User Journey — First Connection. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of User Journey — First Connection.
