---
document_id: FD-ECC8822E
title: "User Journey — Agency Onboarding"
...
# User Journey — Agency Onboarding

## Purpose

Defines the end-to-end actors, prerequisites, steps, system states, handoffs, failures, and completion evidence for agency onboarding.

## Scope

This document is the implementation authority for User Journey — Agency Onboarding. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of User Journey — Agency Onboarding.
