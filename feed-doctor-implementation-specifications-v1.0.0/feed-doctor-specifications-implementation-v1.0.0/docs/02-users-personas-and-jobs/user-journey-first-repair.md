---
document_id: FD-9AA8F878
title: "User Journey — First Repair"
...
# User Journey — First Repair

## Purpose

Defines the end-to-end actors, prerequisites, steps, system states, handoffs, failures, and completion evidence for first repair.

## Scope

This document is the implementation authority for User Journey — First Repair. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of User Journey — First Repair.
