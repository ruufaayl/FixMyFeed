---
document_id: FD-8D8023D0
title: "Persona — Merchant Owner"
...
Defines the goals, permissions, risks, information needs, and success criteria for this persona. Owns revenue outcomes but may not understand feed terminology; needs prioritized risk and safe guided actions.

## Scope

This document is the implementation authority for Persona — Merchant Owner. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Merchant Owner.
...
Owns revenue outcomes but may not understand feed terminology; needs prioritized risk and safe guided actions.
