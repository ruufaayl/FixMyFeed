---
document_id: FD-752F8D7F
title: "User Journey — First Diagnostic Scan"
...
# User Journey — First Diagnostic Scan

## Purpose

Defines the end-to-end actors, prerequisites, steps, system states, handoffs, failures, and completion evidence for first diagnostic scan.

## Scope

This document is the implementation authority for User Journey — First Diagnostic Scan. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of User Journey — First Diagnostic Scan.
