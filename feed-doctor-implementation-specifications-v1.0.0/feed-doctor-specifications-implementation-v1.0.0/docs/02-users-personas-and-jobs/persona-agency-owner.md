---
document_id: FD-3A2F5952
title: "Persona — Agency Owner"
...
Defines the goals, permissions, risks, information needs, and success criteria for this persona. Manages many client stores; needs portfolio health, isolation, delegated access, and branded reporting later.

## Scope

This document is the implementation authority for Persona — Agency Owner. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Agency Owner.
...
Manages many client stores; needs portfolio health, isolation, delegated access, and branded reporting later.
