---
document_id: FD-5BD189A2
title: "Persona — Enterprise Catalog Manager"
...
# Persona — Enterprise Catalog Manager

## Purpose

Defines the goals, permissions, risks, information needs, and success criteria for this persona. Needs scale, change control, four-eyes approval, regional scope, and compliance.

## Scope

This document is the implementation authority for Persona — Enterprise Catalog Manager. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Enterprise Catalog Manager.
...
Needs scale, change control, four-eyes approval, regional scope, and compliance.
