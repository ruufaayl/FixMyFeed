---
document_id: FD-0C041D21
title: "Persona — Ecommerce Manager"
...
Defines the goals, permissions, risks, information needs, and success criteria for this persona. Operates catalog and promotions daily; needs bulk visibility, evidence, and repeatable fixes.

## Scope

This document is the implementation authority for Persona — Ecommerce Manager. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Ecommerce Manager.
...
Operates catalog and promotions daily; needs bulk visibility, evidence, and repeatable fixes.
