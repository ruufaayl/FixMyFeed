---
document_id: FD-2F413A60
title: "Persona — Performance Marketer"
...
Defines the goals, permissions, risks, information needs, and success criteria for this persona. Owns ad performance; needs destination eligibility, impact, timing, and collaboration with catalog owners.

## Scope

This document is the implementation authority for Persona — Performance Marketer. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Performance Marketer.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The experience MUST support this persona without granting permissions beyond their role.
- Terminology, defaults, and progressive disclosure reflect domain knowledge while preserving access to exact evidence.
- Critical actions communicate consequence, authority, reversibility, and verification.
- No persona assumption substitutes for explicit authorization or tenant context.
...
Owns ad performance; needs destination eligibility, impact, timing, and collaboration with catalog owners.

## Primary Workflows

Connect or access stores; assess health; investigate issues; collaborate or approve; verify outcomes; monitor recurrence; produce evidence or reports appropriate to permission.

## Failure Risks

Misunderstood provider terminology, acting on stale data, changing the wrong source, bulk changes without preview, hidden permission barriers, notification fatigue, and inability to prove what changed.
