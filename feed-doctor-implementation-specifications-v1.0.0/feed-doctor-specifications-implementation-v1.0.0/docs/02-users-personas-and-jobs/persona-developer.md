...
Defines the goals, permissions, risks, information needs, and success criteria for this persona. Needs stable APIs, webhooks, logs, test stores, and reproducible error contracts.

## Scope

This document is the implementation authority for Persona — Developer. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Developer.
...
Needs stable APIs, webhooks, logs, test stores, and reproducible error contracts.
