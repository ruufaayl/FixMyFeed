---
document_id: FD-1A57B087
title: "Persona — Agency Account Manager"
...
Defines the goals, permissions, risks, information needs, and success criteria for this persona. Needs client-specific triage, approvals, alerts, and explanations safe to share.

## Scope

This document is the implementation authority for Persona — Agency Account Manager. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Agency Account Manager.
...
Needs client-specific triage, approvals, alerts, and explanations safe to share.
