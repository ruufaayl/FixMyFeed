...
Defines the goals, permissions, risks, information needs, and success criteria for this persona. Needs cross-tenant operational health while preventing content access by default.

## Scope

This document is the implementation authority for Persona — Platform Operator. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Platform Operator.
...
Needs cross-tenant operational health while preventing content access by default.
