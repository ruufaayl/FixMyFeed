---
document_id: FD-F1BC84B7
title: "Persona — Billing Administrator"
...
Defines the goals, permissions, risks, information needs, and success criteria for this persona. Needs subscription, usage, invoice, and plan-limit visibility without catalog access.

## Scope

This document is the implementation authority for Persona — Billing Administrator. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Billing Administrator.
...
Needs subscription, usage, invoice, and plan-limit visibility without catalog access.
