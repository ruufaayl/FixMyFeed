---
document_id: FD-D0BD3B9D
title: "Persona — Security Administrator"
...
Defines the goals, permissions, risks, information needs, and success criteria for this persona. Needs SSO/MFA, least privilege, support-access control, audit, export, and incident evidence.

## Scope

This document is the implementation authority for Persona — Security Administrator. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Security Administrator.
...
Needs SSO/MFA, least privilege, support-access control, audit, export, and incident evidence.
