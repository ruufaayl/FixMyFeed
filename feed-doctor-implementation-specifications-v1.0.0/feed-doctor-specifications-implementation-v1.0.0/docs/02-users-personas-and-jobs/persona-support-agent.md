---
document_id: FD-0B32716D
title: "Persona — Support Agent"
...
Defines the goals, permissions, risks, information needs, and success criteria for this persona. Needs consented diagnostic context without persistent broad customer access.

## Scope

This document is the implementation authority for Persona — Support Agent. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Persona — Support Agent.
...
Needs consented diagnostic context without persistent broad customer access.
