---
document_id: FD-4E840BF4
title: "Restricted Actions And Allowlists"
...
# Restricted Actions And Allowlists

## Purpose

Defines the production implementation, governance, failure behavior, and verification requirements for restricted actions and allowlists.

## Scope

This document is the implementation authority for Restricted Actions And Allowlists. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Restricted Actions And Allowlists.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete restricted actions and allowlists capability according to the reference architecture.
