---
document_id: FD-072A4CA8
title: "Component Specification — Virtualized Table"
...
# Component Specification — Virtualized Table

## Purpose

Defines the reusable design-system contract for the virtualized table component.

## Scope

This document is the implementation authority for Component Specification — Virtualized Table. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — Virtualized Table.
...
The `virtualized_table` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
