---
document_id: FD-F65EE962
title: "Component Specification — Progress Stepper"
...
# Component Specification — Progress Stepper

## Purpose

Defines the reusable design-system contract for the progress stepper component.

## Scope

This document is the implementation authority for Component Specification — Progress Stepper. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — Progress Stepper.
...
The `progress_stepper` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
