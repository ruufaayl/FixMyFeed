---
document_id: FD-73300942
title: "Component Specification — Validation Message"
...
# Component Specification — Validation Message

## Purpose

Defines the reusable design-system contract for the validation message component.

## Scope

This document is the implementation authority for Component Specification — Validation Message. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — Validation Message.
...
The `validation_message` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
