---
document_id: FD-C99DD73F
title: "Component Specification — External Link Warning"
...
# Component Specification — External Link Warning

## Purpose

Defines the reusable design-system contract for the external link warning component.

## Scope

This document is the implementation authority for Component Specification — External Link Warning. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — External Link Warning.
...
The `external_link_warning` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
