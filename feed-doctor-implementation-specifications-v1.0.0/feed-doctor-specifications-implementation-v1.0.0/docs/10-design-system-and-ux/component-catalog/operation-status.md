---
document_id: FD-A050C090
title: "Component Specification — Operation Status"
...
# Component Specification — Operation Status

## Purpose

Defines the reusable design-system contract for the operation status component.

## Scope

This document is the implementation authority for Component Specification — Operation Status. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — Operation Status.
...
The `operation_status` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
