---
document_id: FD-188D2B59
title: "Component Specification — Permission Gate"
...
# Component Specification — Permission Gate

## Purpose

Defines the reusable design-system contract for the permission gate component.

## Scope

This document is the implementation authority for Component Specification — Permission Gate. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — Permission Gate.
...
The `permission_gate` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
