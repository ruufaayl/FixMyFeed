---
document_id: FD-DA40A0CB
title: "Component Specification — Health Score Gauge"
...
# Component Specification — Health Score Gauge

## Purpose

Defines the reusable design-system contract for the health score gauge component.

## Scope

This document is the implementation authority for Component Specification — Health Score Gauge. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — Health Score Gauge.
...
The `health_score_gauge` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
