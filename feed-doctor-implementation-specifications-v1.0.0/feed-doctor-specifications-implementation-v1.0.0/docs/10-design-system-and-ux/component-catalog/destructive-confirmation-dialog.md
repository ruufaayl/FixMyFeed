---
document_id: FD-FF8BE774
title: "Component Specification — Destructive Confirmation Dialog"
...
# Component Specification — Destructive Confirmation Dialog

## Purpose

Defines the reusable design-system contract for the destructive confirmation dialog component.

## Scope

This document is the implementation authority for Component Specification — Destructive Confirmation Dialog. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — Destructive Confirmation Dialog.
...
The `destructive_confirmation_dialog` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
