---
document_id: FD-42C74C64
title: "Component Specification — Saved View Selector"
...
# Component Specification — Saved View Selector

## Purpose

Defines the reusable design-system contract for the saved view selector component.

## Scope

This document is the implementation authority for Component Specification — Saved View Selector. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — Saved View Selector.
...
The `saved_view_selector` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
