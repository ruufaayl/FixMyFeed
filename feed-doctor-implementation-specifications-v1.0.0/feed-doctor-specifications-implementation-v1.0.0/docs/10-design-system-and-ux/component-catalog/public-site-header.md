---
document_id: FD-09807624
title: "Component Specification — Public Site Header"
...
# Component Specification — Public Site Header

## Purpose

Defines the reusable design-system contract for the public site header component.

## Scope

This document is the implementation authority for Component Specification — Public Site Header. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — Public Site Header.
...
The `public_site_header` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
