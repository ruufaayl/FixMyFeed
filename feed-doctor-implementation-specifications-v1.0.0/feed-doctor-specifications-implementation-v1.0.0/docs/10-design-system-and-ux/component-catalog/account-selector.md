---
document_id: FD-4EEF906B
title: "Component Specification — Account Selector"
...
# Component Specification — Account Selector

## Purpose

Defines the reusable design-system contract for the account selector component.

## Scope

This document is the implementation authority for Component Specification — Account Selector. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — Account Selector.
...
The `account_selector` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
