---
document_id: FD-037436E6
title: "Component Specification — Rollback Preview"
...
# Component Specification — Rollback Preview

## Purpose

Defines the reusable design-system contract for the rollback preview component.

## Scope

This document is the implementation authority for Component Specification — Rollback Preview. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Component Specification — Rollback Preview.
...
The `rollback_preview` component exposes only domain-neutral props: identifier, label, description, value/state, disabled/busy/invalid flags, size/density, permitted actions, and event callbacks. Provider payloads and tenant authorization logic are resolved before invocation.
