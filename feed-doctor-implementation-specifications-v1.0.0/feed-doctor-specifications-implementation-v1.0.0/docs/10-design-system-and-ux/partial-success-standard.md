---
document_id: FD-55AAECAB
title: "Partial Success Standard"
...
Defines the production implementation, governance, failure behavior, and verification requirements for partial success standard.

## Scope

This document is the implementation authority for Partial Success Standard. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Partial Success Standard.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete partial success standard capability according to the reference architecture.
