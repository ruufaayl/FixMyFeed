---
document_id: FD-35A3A88B
title: "Reduced Motion Standard"
...
Defines the production implementation, governance, failure behavior, and verification requirements for reduced motion standard.

## Scope

This document is the implementation authority for Reduced Motion Standard. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Reduced Motion Standard.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete reduced motion standard capability according to the reference architecture.
