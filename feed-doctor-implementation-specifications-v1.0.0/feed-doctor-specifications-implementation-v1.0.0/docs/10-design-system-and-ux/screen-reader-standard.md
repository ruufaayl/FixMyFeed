---
document_id: FD-FAF2F547
title: "Screen Reader Standard"
...
Defines the production implementation, governance, failure behavior, and verification requirements for screen reader standard.

## Scope

This document is the implementation authority for Screen Reader Standard. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Screen Reader Standard.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete screen reader standard capability according to the reference architecture.
