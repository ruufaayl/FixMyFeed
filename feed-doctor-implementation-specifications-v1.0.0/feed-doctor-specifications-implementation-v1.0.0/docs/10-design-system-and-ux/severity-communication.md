---
document_id: FD-DD7C86AD
title: "Severity Communication"
...
Defines the production implementation, governance, failure behavior, and verification requirements for severity communication.

## Scope

This document is the implementation authority for Severity Communication. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Severity Communication.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete severity communication capability according to the reference architecture.
