...
Defines the production implementation, governance, failure behavior, and verification requirements for open graph and social metadata.

## Scope

This document is the implementation authority for Open Graph And Social Metadata. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Open Graph And Social Metadata.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete open graph and social metadata capability according to the reference architecture.
