---
document_id: FD-E79F1373
title: "Runbook — Billing Provider Outage"
...
# Runbook — Billing Provider Outage

## Purpose

Defines detection, triage, containment, recovery, communication, evidence, and follow-up for billing provider outage.

## Scope

This document is the implementation authority for Runbook — Billing Provider Outage. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Billing Provider Outage.
