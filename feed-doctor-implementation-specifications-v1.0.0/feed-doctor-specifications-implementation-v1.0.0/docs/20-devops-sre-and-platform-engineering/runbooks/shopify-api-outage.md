---
document_id: FD-F7A78D66
title: "Runbook — Shopify Api Outage"
...
# Runbook — Shopify Api Outage

## Purpose

Defines detection, triage, containment, recovery, communication, evidence, and follow-up for shopify api outage.

## Scope

This document is the implementation authority for Runbook — Shopify Api Outage. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Shopify Api Outage.
