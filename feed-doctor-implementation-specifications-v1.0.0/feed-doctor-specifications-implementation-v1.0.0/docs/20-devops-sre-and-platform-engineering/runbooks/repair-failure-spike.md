---
document_id: FD-B6638532
title: "Runbook — Repair Failure Spike"
...
# Runbook — Repair Failure Spike

## Purpose

Defines detection, triage, containment, recovery, communication, evidence, and follow-up for repair failure spike.

## Scope

This document is the implementation authority for Runbook — Repair Failure Spike. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Repair Failure Spike.
