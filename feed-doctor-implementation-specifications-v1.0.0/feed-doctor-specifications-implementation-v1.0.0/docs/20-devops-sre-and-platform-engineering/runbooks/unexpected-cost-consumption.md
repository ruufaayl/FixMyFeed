---
document_id: FD-C7B15B6F
title: "Runbook — Unexpected Cost Consumption"
...
# Runbook — Unexpected Cost Consumption

## Purpose

Defines detection, triage, containment, recovery, communication, evidence, and follow-up for unexpected cost consumption.

## Scope

This document is the implementation authority for Runbook — Unexpected Cost Consumption. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Unexpected Cost Consumption.
