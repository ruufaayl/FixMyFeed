---
document_id: FD-90D67826
title: "Runbook — Synchronization Delay"
...
# Runbook — Synchronization Delay

## Purpose

Defines detection, triage, containment, recovery, communication, evidence, and follow-up for synchronization delay.

## Scope

This document is the implementation authority for Runbook — Synchronization Delay. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Synchronization Delay.
