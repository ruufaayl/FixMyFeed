---
document_id: FD-FC27CABF
title: "Runbook — Object Storage Outage"
...
Defines detection, triage, containment, recovery, communication, evidence, and follow-up for object storage outage.

## Scope

This document is the implementation authority for Runbook — Object Storage Outage. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Object Storage Outage.
