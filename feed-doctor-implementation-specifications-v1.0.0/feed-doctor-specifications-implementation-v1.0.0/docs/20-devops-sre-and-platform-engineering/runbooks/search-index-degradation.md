---
document_id: FD-5937A120
title: "Runbook — Search Index Degradation"
...
# Runbook — Search Index Degradation

## Purpose

Defines detection, triage, containment, recovery, communication, evidence, and follow-up for search index degradation.

## Scope

This document is the implementation authority for Runbook — Search Index Degradation. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Search Index Degradation.
