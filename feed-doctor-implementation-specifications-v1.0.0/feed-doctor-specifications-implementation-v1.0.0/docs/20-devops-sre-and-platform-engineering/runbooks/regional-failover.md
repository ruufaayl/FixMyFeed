---
document_id: FD-5F878E98
title: "Runbook — Regional Failover"
...
Defines detection, triage, containment, recovery, communication, evidence, and follow-up for regional failover.

## Scope

This document is the implementation authority for Runbook — Regional Failover. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Regional Failover.
