---
document_id: FD-08E54556
title: "Runbook — Public Tool Abuse"
...
# Runbook — Public Tool Abuse

## Purpose

Defines detection, triage, containment, recovery, communication, evidence, and follow-up for public tool abuse.

## Scope

This document is the implementation authority for Runbook — Public Tool Abuse. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Public Tool Abuse.
