---
document_id: FD-13270CDC
title: "Runbook — Database Degradation"
...
Defines detection, triage, containment, recovery, communication, evidence, and follow-up for database degradation.

## Scope

This document is the implementation authority for Runbook — Database Degradation. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Database Degradation.
