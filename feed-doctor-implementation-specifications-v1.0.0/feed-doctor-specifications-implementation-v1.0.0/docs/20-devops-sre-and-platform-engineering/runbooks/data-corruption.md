---
document_id: FD-26C16D54
title: "Runbook — Data Corruption"
...
Defines detection, triage, containment, recovery, communication, evidence, and follow-up for data corruption.

## Scope

This document is the implementation authority for Runbook — Data Corruption. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Data Corruption.
