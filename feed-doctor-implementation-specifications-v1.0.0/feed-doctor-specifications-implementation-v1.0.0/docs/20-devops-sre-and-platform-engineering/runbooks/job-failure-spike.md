---
document_id: FD-6D891FED
title: "Runbook — Job Failure Spike"
...
# Runbook — Job Failure Spike

## Purpose

Defines detection, triage, containment, recovery, communication, evidence, and follow-up for job failure spike.

## Scope

This document is the implementation authority for Runbook — Job Failure Spike. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Job Failure Spike.
