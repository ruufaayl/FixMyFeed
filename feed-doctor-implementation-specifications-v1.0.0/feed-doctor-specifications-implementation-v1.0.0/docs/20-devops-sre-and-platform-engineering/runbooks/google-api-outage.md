---
document_id: FD-85D7B5F7
title: "Runbook — Google Api Outage"
...
# Runbook — Google Api Outage

## Purpose

Defines detection, triage, containment, recovery, communication, evidence, and follow-up for google api outage.

## Scope

This document is the implementation authority for Runbook — Google Api Outage. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Google Api Outage.
