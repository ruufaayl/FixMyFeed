---
document_id: FD-C80471A9
title: "Runbook — Connector Outage"
...
Defines detection, triage, containment, recovery, communication, evidence, and follow-up for connector outage.

## Scope

This document is the implementation authority for Runbook — Connector Outage. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Connector Outage.
