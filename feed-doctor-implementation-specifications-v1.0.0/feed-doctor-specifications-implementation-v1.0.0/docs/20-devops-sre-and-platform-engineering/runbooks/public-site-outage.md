---
document_id: FD-D18254D5
title: "Runbook — Public Site Outage"
...
# Runbook — Public Site Outage

## Purpose

Defines detection, triage, containment, recovery, communication, evidence, and follow-up for public site outage.

## Scope

This document is the implementation authority for Runbook — Public Site Outage. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Public Site Outage.
