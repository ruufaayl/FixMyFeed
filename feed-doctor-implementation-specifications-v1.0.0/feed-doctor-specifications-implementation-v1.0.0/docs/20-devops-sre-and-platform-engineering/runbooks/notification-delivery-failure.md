---
document_id: FD-B615C4EF
title: "Runbook — Notification Delivery Failure"
...
Defines detection, triage, containment, recovery, communication, evidence, and follow-up for notification delivery failure.

## Scope

This document is the implementation authority for Runbook — Notification Delivery Failure. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Notification Delivery Failure.
