---
document_id: FD-A1B55C4F
title: "Runbook — Webhook Signature Failure Spike"
...
Defines detection, triage, containment, recovery, communication, evidence, and follow-up for webhook signature failure spike.

## Scope

This document is the implementation authority for Runbook — Webhook Signature Failure Spike. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Webhook Signature Failure Spike.
