---
document_id: FD-A721130F
title: "Runbook — Queue Backlog"
...
Defines detection, triage, containment, recovery, communication, evidence, and follow-up for queue backlog.

## Scope

This document is the implementation authority for Runbook — Queue Backlog. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Runbook — Queue Backlog.
