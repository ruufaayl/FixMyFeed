---
document_id: FD-C940FE50
title: "Connector Slos"
...
Defines the production implementation, governance, failure behavior, and verification requirements for connector slos.

## Scope

This document is the implementation authority for Connector Slos. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Connector Slos.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete connector slos capability according to the reference architecture.
