---
document_id: FD-887389CF
title: "Background Job Slos"
...
Defines the production implementation, governance, failure behavior, and verification requirements for background job slos.

## Scope

This document is the implementation authority for Background Job Slos. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Background Job Slos.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete background job slos capability according to the reference architecture.
