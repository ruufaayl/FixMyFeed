---
document_id: FD-40580C75
title: "Page Specification — Repair Preview"
...
# Page Specification — Repair Preview

## Purpose

Defines the complete user experience and implementation contract for the repair preview workflow.

## Scope

This document is the implementation authority for Page Specification — Repair Preview. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- Completion or safe interruption of the `repair preview` workflow.
- Analytics events, audit events, and navigation outcomes defined below.
- No hidden or ambiguous side effects.

## Functional Requirements

- The page MUST solve one primary workflow: repair preview.
- Canonical route: `/app/repair-preview`; route parameters are opaque IDs or validated slugs.
...
- `page_viewed` with `page_id=repair-preview` and authorized context classification.
- `repair_preview_primary_action_started`.
