---
document_id: FD-6222DDF5
title: "Page Specification — Compliance Center"
...
# Page Specification — Compliance Center

## Purpose

Defines the complete user experience and implementation contract for the compliance center workflow.

## Scope

This document is the implementation authority for Page Specification — Compliance Center. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- Completion or safe interruption of the `compliance center` workflow.
- Analytics events, audit events, and navigation outcomes defined below.
- No hidden or ambiguous side effects.

## Functional Requirements

- The page MUST solve one primary workflow: compliance center.
- Canonical route: `/app/compliance-center`; route parameters are opaque IDs or validated slugs.
...
- `page_viewed` with `page_id=compliance-center` and authorized context classification.
- `compliance_center_primary_action_started`.
