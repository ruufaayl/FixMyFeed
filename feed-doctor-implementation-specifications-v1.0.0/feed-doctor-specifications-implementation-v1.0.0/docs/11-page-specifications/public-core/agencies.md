---
document_id: FD-1BD1865B
title: "Page Specification — Agencies"
...
# Page Specification — Agencies

## Purpose

Defines the complete user experience and implementation contract for the agencies workflow.

## Scope

This document is the implementation authority for Page Specification — Agencies. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- Completion or safe interruption of the `agencies` workflow.
- Analytics events, audit events, and navigation outcomes defined below.
- No hidden or ambiguous side effects.

## Functional Requirements

- The page MUST solve one primary workflow: agencies.
- Canonical route: `/agencies`; route parameters are opaque IDs or validated slugs.
...
- `page_viewed` with `page_id=agencies` and authorized context classification.
- `agencies_primary_action_started`.
