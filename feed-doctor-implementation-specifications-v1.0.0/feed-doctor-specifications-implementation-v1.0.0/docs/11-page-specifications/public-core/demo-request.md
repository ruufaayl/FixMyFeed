---
document_id: FD-44859486
title: "Page Specification — Demo Request"
...
# Page Specification — Demo Request

## Purpose

Defines the complete user experience and implementation contract for the demo request workflow.

## Scope

This document is the implementation authority for Page Specification — Demo Request. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- Completion or safe interruption of the `demo request` workflow.
- Analytics events, audit events, and navigation outcomes defined below.
- No hidden or ambiguous side effects.

## Functional Requirements

- The page MUST solve one primary workflow: demo request.
- Canonical route: `/demo-request`; route parameters are opaque IDs or validated slugs.
...
- `page_viewed` with `page_id=demo-request` and authorized context classification.
- `demo_request_primary_action_started`.
