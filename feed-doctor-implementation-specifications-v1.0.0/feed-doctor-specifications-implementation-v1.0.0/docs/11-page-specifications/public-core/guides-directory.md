---
document_id: FD-F1C1FEA2
title: "Page Specification — Guides Directory"
...
# Page Specification — Guides Directory

## Purpose

Defines the complete user experience and implementation contract for the guides directory workflow.

## Scope

This document is the implementation authority for Page Specification — Guides Directory. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- Completion or safe interruption of the `guides directory` workflow.
- Analytics events, audit events, and navigation outcomes defined below.
- No hidden or ambiguous side effects.

## Functional Requirements

- The page MUST solve one primary workflow: guides directory.
- Canonical route: `/guides-directory`; route parameters are opaque IDs or validated slugs.
...
- `page_viewed` with `page_id=guides-directory` and authorized context classification.
- `guides_directory_primary_action_started`.
