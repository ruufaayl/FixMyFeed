---
document_id: FD-BF1FD88F
title: "Page Specification — Integrations"
...
# Page Specification — Integrations

## Purpose

Defines the complete user experience and implementation contract for the integrations workflow.

## Scope

This document is the implementation authority for Page Specification — Integrations. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- Completion or safe interruption of the `integrations` workflow.
- Analytics events, audit events, and navigation outcomes defined below.
- No hidden or ambiguous side effects.

## Functional Requirements

- The page MUST solve one primary workflow: integrations.
- Canonical route: `/integrations`; route parameters are opaque IDs or validated slugs.
...
- `page_viewed` with `page_id=integrations` and authorized context classification.
- `integrations_primary_action_started`.
