---
document_id: FD-4E2F1DD4
title: "Algorithm Specification — Variant Image Consistency Validator"
...
# Algorithm Specification — Variant Image Consistency Validator

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for variant image consistency validator.

## Scope

This document is the implementation authority for Algorithm Specification — Variant Image Consistency Validator. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `variant-image-consistency-validator` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-VARIANT-IMAGE-CONSISTENCY-VALIDATOR`
