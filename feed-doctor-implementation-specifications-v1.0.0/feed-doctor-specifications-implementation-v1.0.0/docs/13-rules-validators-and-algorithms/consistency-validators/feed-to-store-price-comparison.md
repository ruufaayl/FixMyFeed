---
document_id: FD-BC5253F3
title: "Algorithm Specification — Feed To Store Price Comparison"
...
- The `feed-to-store-price-comparison` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-FEED-TO-STORE-PRICE-COMPARISON`
