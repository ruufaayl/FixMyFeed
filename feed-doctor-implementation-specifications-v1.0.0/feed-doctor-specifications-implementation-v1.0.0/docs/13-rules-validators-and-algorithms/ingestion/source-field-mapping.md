---
document_id: FD-88C04AE9
title: "Algorithm Specification — Source Field Mapping"
...
# Algorithm Specification — Source Field Mapping

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for source field mapping.

## Scope

This document is the implementation authority for Algorithm Specification — Source Field Mapping. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `source-field-mapping` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-SOURCE-FIELD-MAPPING`
