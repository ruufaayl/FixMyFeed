---
document_id: FD-1572EA35
title: "Algorithm Specification — Repair Dependency Ordering"
...
# Algorithm Specification — Repair Dependency Ordering

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for repair dependency ordering.
...
- The `repair-dependency-ordering` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-REPAIR-DEPENDENCY-ORDERING`
