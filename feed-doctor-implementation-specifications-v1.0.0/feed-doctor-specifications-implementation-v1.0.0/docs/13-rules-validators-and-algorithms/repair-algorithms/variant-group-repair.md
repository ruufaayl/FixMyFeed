---
document_id: FD-8E64A945
title: "Algorithm Specification — Variant Group Repair"
...
# Algorithm Specification — Variant Group Repair

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for variant group repair.

## Scope

This document is the implementation authority for Algorithm Specification — Variant Group Repair. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `variant-group-repair` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-VARIANT-GROUP-REPAIR`
