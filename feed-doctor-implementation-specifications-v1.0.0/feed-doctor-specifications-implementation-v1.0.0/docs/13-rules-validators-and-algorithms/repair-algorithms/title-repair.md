---
document_id: FD-848E9D20
title: "Algorithm Specification — Title Repair"
...
# Algorithm Specification — Title Repair

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for title repair.

## Scope

This document is the implementation authority for Algorithm Specification — Title Repair. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `title-repair` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-TITLE-REPAIR`
