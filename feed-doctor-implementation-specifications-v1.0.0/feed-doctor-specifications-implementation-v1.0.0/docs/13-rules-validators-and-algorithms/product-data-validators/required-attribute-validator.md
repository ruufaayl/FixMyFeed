---
document_id: FD-31EB8584
title: "Algorithm Specification — Required Attribute Validator"
...
# Algorithm Specification — Required Attribute Validator

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for required attribute validator.

## Scope

This document is the implementation authority for Algorithm Specification — Required Attribute Validator. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `required-attribute-validator` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-REQUIRED-ATTRIBUTE-VALIDATOR`
