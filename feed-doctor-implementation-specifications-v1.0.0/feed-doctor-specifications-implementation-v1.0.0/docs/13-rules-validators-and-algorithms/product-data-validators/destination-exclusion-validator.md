---
document_id: FD-DFFAB8D0
title: "Algorithm Specification — Destination Exclusion Validator"
...
- The `destination-exclusion-validator` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-DESTINATION-EXCLUSION-VALIDATOR`
