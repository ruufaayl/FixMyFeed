---
document_id: FD-FA1CF2CC
title: "Algorithm Specification — Html And Markup Validator"
...
# Algorithm Specification — Html And Markup Validator

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for html and markup validator.

## Scope

This document is the implementation authority for Algorithm Specification — Html And Markup Validator. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `html-and-markup-validator` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-HTML-AND-MARKUP-VALIDATOR`
