---
document_id: FD-A1882545
title: "Algorithm Specification — Variant Consistency Validator"
...
# Algorithm Specification — Variant Consistency Validator

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for variant consistency validator.
...
- The `variant-consistency-validator` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-VARIANT-CONSISTENCY-VALIDATOR`
