---
document_id: FD-9E8E2281
title: "Algorithm Specification — Issue Occurrence Deduplication"
...
# Algorithm Specification — Issue Occurrence Deduplication

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for issue occurrence deduplication.

## Scope

This document is the implementation authority for Algorithm Specification — Issue Occurrence Deduplication. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `issue-occurrence-deduplication` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-ISSUE-OCCURRENCE-DEDUPLICATION`
