---
document_id: FD-CA7B19CF
title: "Algorithm Specification — Source Issue Normalization"
...
# Algorithm Specification — Source Issue Normalization

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for source issue normalization.

## Scope

This document is the implementation authority for Algorithm Specification — Source Issue Normalization. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `source-issue-normalization` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-SOURCE-ISSUE-NORMALIZATION`
