---
document_id: FD-A40182CE
title: "Algorithm Specification — Issue Page Canonicalization"
...
# Algorithm Specification — Issue Page Canonicalization

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for issue page canonicalization.

## Scope

This document is the implementation authority for Algorithm Specification — Issue Page Canonicalization. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `issue-page-canonicalization` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-ISSUE-PAGE-CANONICALIZATION`
