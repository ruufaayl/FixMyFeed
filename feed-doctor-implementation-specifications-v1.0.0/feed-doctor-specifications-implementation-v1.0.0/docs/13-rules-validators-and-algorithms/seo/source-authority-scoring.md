---
document_id: FD-E221BABF
title: "Algorithm Specification — Source Authority Scoring"
...
# Algorithm Specification — Source Authority Scoring

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for source authority scoring.

## Scope

This document is the implementation authority for Algorithm Specification — Source Authority Scoring. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `source-authority-scoring` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-SOURCE-AUTHORITY-SCORING`
