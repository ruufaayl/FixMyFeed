---
document_id: FD-B0FADC2E
title: "Algorithm Specification — Sitemap Prioritization"
...
# Algorithm Specification — Sitemap Prioritization

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for sitemap prioritization.

## Scope

This document is the implementation authority for Algorithm Specification — Sitemap Prioritization. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `sitemap-prioritization` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-SITEMAP-PRIORITIZATION`
