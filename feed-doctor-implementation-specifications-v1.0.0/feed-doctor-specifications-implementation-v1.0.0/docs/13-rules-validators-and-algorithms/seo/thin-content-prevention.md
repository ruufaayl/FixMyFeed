---
document_id: FD-4987C370
title: "Algorithm Specification — Thin Content Prevention"
...
# Algorithm Specification — Thin Content Prevention

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for thin content prevention.

## Scope

This document is the implementation authority for Algorithm Specification — Thin Content Prevention. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `thin-content-prevention` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-THIN-CONTENT-PREVENTION`
