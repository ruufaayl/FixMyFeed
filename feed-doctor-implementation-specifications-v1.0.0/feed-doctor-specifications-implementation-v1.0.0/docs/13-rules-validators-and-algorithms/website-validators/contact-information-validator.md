---
document_id: FD-CF1204FF
title: "Algorithm Specification — Contact Information Validator"
...
# Algorithm Specification — Contact Information Validator

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for contact information validator.

## Scope

This document is the implementation authority for Algorithm Specification — Contact Information Validator. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `contact-information-validator` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-CONTACT-INFORMATION-VALIDATOR`
