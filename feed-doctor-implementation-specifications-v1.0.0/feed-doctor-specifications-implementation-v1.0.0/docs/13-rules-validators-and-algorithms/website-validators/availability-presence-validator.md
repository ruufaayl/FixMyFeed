---
document_id: FD-077E74D8
title: "Algorithm Specification — Availability Presence Validator"
...
# Algorithm Specification — Availability Presence Validator

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for availability presence validator.

## Scope

This document is the implementation authority for Algorithm Specification — Availability Presence Validator. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `availability-presence-validator` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-AVAILABILITY-PRESENCE-VALIDATOR`
