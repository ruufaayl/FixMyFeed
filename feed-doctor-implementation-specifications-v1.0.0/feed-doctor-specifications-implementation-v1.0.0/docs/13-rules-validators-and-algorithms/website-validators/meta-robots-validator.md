---
document_id: FD-84723482
title: "Algorithm Specification — Meta Robots Validator"
...
# Algorithm Specification — Meta Robots Validator

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for meta robots validator.

## Scope

This document is the implementation authority for Algorithm Specification — Meta Robots Validator. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `meta-robots-validator` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-META-ROBOTS-VALIDATOR`
