---
document_id: FD-BBA78A0B
title: "Algorithm Specification — Shipping Policy Validator"
...
# Algorithm Specification — Shipping Policy Validator

## Purpose

Defines the deterministic algorithm, inputs, outputs, invariants, complexity, evidence, failure behavior, and evaluation tests for shipping policy validator.

## Scope

This document is the implementation authority for Algorithm Specification — Shipping Policy Validator. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- The `shipping-policy-validator` algorithm MUST be deterministic for identical normalized inputs and reference-data versions.
...
**Stable identifier:** `ALG-SHIPPING-POLICY-VALIDATOR`
