---
document_id: FD-EE7BCCC9
title: "Synthetic Merchant Accounts"
...
Defines the production implementation, governance, failure behavior, and verification requirements for synthetic merchant accounts.

## Scope

This document is the implementation authority for Synthetic Merchant Accounts. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Synthetic Merchant Accounts.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete synthetic merchant accounts capability according to the reference architecture.
