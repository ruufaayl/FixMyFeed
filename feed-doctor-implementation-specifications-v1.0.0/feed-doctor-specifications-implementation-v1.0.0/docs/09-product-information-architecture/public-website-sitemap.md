---
document_id: FD-C6491392
title: "Public Website Sitemap"
...
Defines the production implementation, governance, failure behavior, and verification requirements for public website sitemap.

## Scope

This document is the implementation authority for Public Website Sitemap. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Public Website Sitemap.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete public website sitemap capability according to the reference architecture.
