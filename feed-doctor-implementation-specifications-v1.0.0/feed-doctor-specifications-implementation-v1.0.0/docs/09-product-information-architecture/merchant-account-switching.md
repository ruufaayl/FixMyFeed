---
document_id: FD-6EF015FF
title: "Merchant Account Switching"
...
# Merchant Account Switching

## Purpose

Defines the production implementation, governance, failure behavior, and verification requirements for merchant account switching.

## Scope

This document is the implementation authority for Merchant Account Switching. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Merchant Account Switching.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete merchant account switching capability according to the reference architecture.
