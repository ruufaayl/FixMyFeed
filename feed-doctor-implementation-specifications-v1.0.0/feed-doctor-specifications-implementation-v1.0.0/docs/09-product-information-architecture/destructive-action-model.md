---
document_id: FD-29811243
title: "Destructive Action Model"
...
Defines the production implementation, governance, failure behavior, and verification requirements for destructive action model.

## Scope

This document is the implementation authority for Destructive Action Model. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Destructive Action Model.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete destructive action model capability according to the reference architecture.
