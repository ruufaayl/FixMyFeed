---
document_id: FD-B35CC753
title: "Agency Information Architecture"
...
Defines the production implementation, governance, failure behavior, and verification requirements for agency information architecture.

## Scope

This document is the implementation authority for Agency Information Architecture. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Agency Information Architecture.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete agency information architecture capability according to the reference architecture.
