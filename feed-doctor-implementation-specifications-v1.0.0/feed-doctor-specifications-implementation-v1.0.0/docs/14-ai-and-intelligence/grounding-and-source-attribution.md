---
document_id: FD-8CADD85C
title: "Grounding And Source Attribution"
...
Defines the production implementation, governance, failure behavior, and verification requirements for grounding and source attribution.

## Scope

This document is the implementation authority for Grounding And Source Attribution. It defines behavior, boundaries, contracts, failure handling, verification, and ownership. Any implementation that conflicts with this document requires an approved ADR and documentation change before merge.
...
- A conforming implementation of Grounding And Source Attribution.
- Traceable tests and operational evidence.
- Auditable state transitions and failure records.

## Functional Requirements

- The implementation MUST provide the complete grounding and source attribution capability according to the reference architecture.
